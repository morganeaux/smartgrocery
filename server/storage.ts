...
export class MemStorage implements IStorage {
  ...
  private initializeDefaultData() {
    ...
    const sampleProducts: Product[] = [
      ...
      // Haferflocken Produkte für Carousel Demo
      {
        id: randomUUID(),
        ...
        sodiumCalorieRatio: null,
        healthScore: 5,
        aiEvaluation: "Premium Bio-Haferflocken mit ausgezeichneter Nährstoffdichte.",
        nutritionData: null
      },
      {
        id: randomUUID(),
        ...
        sodiumCalorieRatio: null,
        healthScore: 4,
        aiEvaluation: "Hochwertige deutsche Haferflocken mit traditioneller Qualität.",
        nutritionData: null
      },
      {
        id: randomUUID(),
        ...
        sodiumCalorieRatio: null,
        healthScore: 5,
        aiEvaluation: "Zertifiziert glutenfreie Bio-Haferflocken für besondere Ernährungsbedürfnisse.",
        nutritionData: null
      },
      {
        id: randomUUID(),
        name: "Protein Haferflocken",
        brand: "MyMuesli",
        price: 4.99,
        size: "500g",
        supermarket: "Edeka",
        ...
        sodiumCalorieRatio: null,
        healthScore: 3,
        aiEvaluation: "Angereicherte Haferflocken mit zusätzlichem Protein, jedoch verarbeitet.",
        nutritionData: null
      },
      {
        id: randomUUID(),
        name: "Instant Haferflocken",
        brand: "Verival",
        price: 2.79,
        size: "500g",
        supermarket: "REWE",
        ...
        sodiumCalorieRatio: null,
        healthScore: 4,
        aiEvaluation: "Bio-Haferflocken mit schneller Zubereitung, leicht verarbeitet.",
        nutritionData: null
      }
    ];
